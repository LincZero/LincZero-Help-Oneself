...
|                        | 字 段                                                  | 词 页                                                        | 顶                                                           |
| ---------------------- | ------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| 行移 (2)               | 字移<br /><kbd>←</kbd> <kbd>→</kbd>                    | 词移<br /><kbd>Ctrl</kbd> + <kbd>←</kbd> <kbd>→</kbd>        | 顶移<br /><kbd>Home</kbd> <kbd>End</kbd>                     |
| 段移 (2)               | 段移<br /><kbd>↑</kbd> <kbd>↓</kbd>                    | *页移*<br /><kbd>PageUp</kbd> <kbd>PageDown</kbd>            | *顶移*<br /><kbd>Ctrl</kbd> + <kbd>Home</kbd> <kbd>End</kbd> |
| 删除 (2)               | 字删<br /><kbd>Backspace</kbd> <kbd>Delete</kbd>       | 词删<br /><kbd>Ctrl</kbd> + <kbd>Backspace</kbd> <kbd>Delete</kbd> | 行删 (部分)<br /><kbd>Ctrl</kbd> + <kbd>D</kbd>              |
...
| 新增 (1)               | 当前位置增加空行<br /><kbd>Enter</kbd>                 | 末尾位置增加空行<br /><kbd>End</kbd>，<kbd>Enter</kbd>       | 拷贝增加行 (部分)<br /><kbd>Ctrl</kbd> + <kbd>D</kbd>        |
|                        | -------------------------------------------            | -------------------------------------------                  | -------------------------------------------                  |
...
|          | 字 段                                        | 词 页                                                        | 顶                                                           |
| -------- | -------------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| 行移 (2) | <kbd>CL</kbd> + <kbd>J</kbd> <kbd>L</kbd>    | <kbd>CL</kbd> + <kbd>F</kbd> + <kbd>J</kbd> <kbd>L</kbd>     | <kbd>CL</kbd> + <kbd>G</kbd> + <kbd>J</kbd> <kbd>K</kbd> 或 <kbd>CL</kbd> + <kbd>H</kbd> <kbd>;</kbd> |
| 段移 (2) | <kbd>CL</kbd> + <kbd>U</kbd> <kbd>K</kbd>    | ~~<kbd>CL</kbd> + <kbd>F</kbd> + <kbd>U</kbd> <kbd>K</kbd>~~ 或 <kbd>CL</kbd> + <kbd>[</kbd> <kbd>]</kbd> | <kbd>CL</kbd> + <kbd>G</kbd> + <kbd>U</kbd> <kbd>K</kbd>     |
| 删除 (3) | <kbd>CL</kbd> + <kbd>I</kbd> <kbd>O</kbd>    | <kbd>CL</kbd> + <kbd>F</kbd> + <kbd>I</kbd> <kbd>O</kbd>     | <kbd>CL</kbd> + <kbd>G</kbd> + <kbd>I / O</kbd> 或 <kbd>CL Sh</kbd> + <kbd>I</kbd> <kbd>O</kbd> |
| 选中 (1) | <kbd>CL Sh</kbd> + <kbd>J</kbd> <kbd>L</kbd> | <kbd>CL</kbd> + <kbd>F</kbd>                                 | <kbd>CL</kbd> + <kbd>G</kbd>                                 |
| 新增     | <kbd>CL</kbd> + <kbd>Space</kbd>             | <kbd>CL</kbd> + <kbd>F</kbd> + <kbd>Space</kbd>              | <kbd>CL</kbd> + <kbd>G</kbd> + <kbd>Space</kbd>              |
|          | -------------------------------------------  | -------------------------------------------                  | -------------------------------------------                  |
