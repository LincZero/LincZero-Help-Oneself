...
- F + 四种移位操作，解释为**选**。其他操作，解释为**行**
- G + 四种移位操作，解释为**词**
- H; + 无修饰键，解释为**行**。有修饰键，解释为**选**
...
#### 编辑器 内容 需求表（ZXCV SADFG）

（需要注意的是，D键~G键 已经被增删查占用了）
...
> 需要修改的坏习惯
>
> <kbd>CapsLock</kbd> + <kbd>D</kbd> 里的D要用中指而非无名指按
...
| ---- | -------- | -------- | -------- | -------- | -------------- | -------------- | ------------ | ------------ | ------------ | ------ |
| 无   | 字上     | 字下     | 字左     | 字右     | ==**最**==左   | ==**最**==右   | 前删         | 后删         |              | 新行   |
| F    | **选**上 | **选**下 | **选**左 | **选**右 | **选==行==**左 | **选==行==**右 | ==**行**==删 | ==**行**==删 | ==**行**==选 | 新空行 |
| G    | ~~词上~~ | ~~词下~~ | **词**左 | **词**右 | **选词**左     | **选词**右     | **词**删     | **词**删     | **词**选     | 拷贝行 |
